        ...
        <base-material-card color="warning">
          ...
          <v-form>
            <v-container class="py-0">
              <v-row>
                <v-col cols="6">
                  <v-text-field v-model="user_name" label="User Name" class="purple-input" />
                </v-col>
                <v-col cols="6">
                  <v-text-field
                    v-model="address"
                ...
                <v-col cols="6">
                  <v-text-field v-model="date" label="Date" class="purple-input" type="date" />
                </v-col>
                <v-select
                  v-model="type"
